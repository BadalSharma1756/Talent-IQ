...
print(maxArea([1,1]))  # Expected: 1`,
  ...
  "fizz-buzz": {
    ...
    description: {
      text: "Given an integer n, return a string array answer (1-indexed) where answer[i] == 'FizzBuzz' if i is divisible by 3 and 5, 'Fizz' if divisible by 3, 'Buzz' if divisible by 5, and i if none of these match.",
      notes: [],
    },
    examples: [
      {
...
class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(fizzBuzz(3).toString().replaceAll(" ", "")); // Expected: [1,2,Fizz]
        System.out.println(fizzBuzz(5).toString().replaceAll(" ", "")); // Expected: [1,2,Fizz,4,Buzz]
    }
}`,
    },
    expectedOutput: {
...
print(climbStairs(3))  # Expected: 3`,
  ...
  "fibonacci-number": {
    ...
    description: {
      ...
      notes: ["F(0) = 0, F(1) = 1", "F(n) = F(n - 1) + F(n - 2), for n > 1.", "Given n, calculate F(n)."],
    },
    examples: [
      {
        input: "n = 2",
